...
export const ThemeConfig = {
  ...
  hero: {
    ...
    mobileFocalPoints: {
      '01': '60%', // Пример: для файла 01...jpg сместить фокус левее
      '02': '45%', // Пример: для файла 02...jpg сместить фокус правее
	  '03': '67%', // Пример: для файла 02...jpg сместить фокус правее
	  '10': '70%', // Пример: для файла 02...jpg сместить фокус правее
