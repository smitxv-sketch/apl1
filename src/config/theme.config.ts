...
export const ThemeConfig = {
  ...
  hero: {
    ...
    mobileFocalPoints: {
      '01': '62%', // Пример: для файла 01...jpg сместить фокус левее
      '02': '60%', // Пример: для файла 02...jpg сместить фокус правее
	  '03': '67%', // Пример: для файла 02...jpg сместить фокус правее
	  '04': '80%', // Пример: для файла 02...jpg сместить фокус правее
