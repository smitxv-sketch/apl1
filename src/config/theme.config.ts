...
export const ThemeConfig = {
  ...
  hero: {
    ...
    mobileFocalPoints: {
      '01': '30%', // Пример: для файла 01...jpg сместить фокус левее
      '02': '40%', // Пример: для файла 02...jpg сместить фокус правее
      '03': '30%', // Пример: для файла 02...jpg сместить фокус правее
